...
- `sync-context.sh`: sincroniza SOUL e skills do repositório para `~/.hermes`
- `RUNBOOK.md`: instalação, cutover e rollback
- `CUTOVER-CHECKLIST.md`: checklist objetivo para a virada

## Decisões já adaptadas ao runtime real do Hermes

- Hermes `v2026.3.17`
- sem provider nativo Vertex no runtime do Hermes
- `fallback_model` único no `config.yaml`
