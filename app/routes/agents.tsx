  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">Agentes de IA e base operacional do Hermes Agent.</p>
      </div>
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
              {modelChain.map((modelId, index) => {
                const model = modelLabels[modelId] ?? {
                  ...
                  description: "Modelo configurado no runtime do Hermes Agent.",
                };
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div className="mb-3 flex items-center gap-2">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-gray-100">Observabilidade Hermes Agent</h3>
            </div>
                  ...
                  {openClawObservability.recentHandoffs.slice(0, 5).map((handoff) => (
                    <div key={handoff.id} className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs dark:border-gray-700 dark:bg-gray-900">
                      ...
                      <p className="mt-1 text-gray-500 dark:text-gray-400">
                        {handoff.fromAgentId || "Hermes Agent"} → {handoff.toAgentId} • {handoff.status}
                      </p>
                    </div>
                  ))}
