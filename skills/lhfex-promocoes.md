...
6. Para tarefas do modulo Literario, a escrita autoral deve ser delegada para a skill `musa-literaria`.
7. Fora do modulo Literario, nao usar a skill `musa-literaria`.
